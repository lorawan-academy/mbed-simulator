...
//define interval between messages in sec
...
#define HUM_DELTA            300

//define the buffer size in number of bytes, 2 for temperature, 2 for humdity
...
static void check_sensor(){
    ...
    static int stored_humidity=0; // latest humidity sent over LoRaWAN
    ...
    humidity>(stored_humidity+HUM_DELTA) || humidity < (stored_humidity-HUM_DELTA)
    ){
